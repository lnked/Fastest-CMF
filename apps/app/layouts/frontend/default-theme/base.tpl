...
<main>
    <header>
        <nav>
            ...
            <a href="/gallery"{if $app.controller == 'gallery' && !isset($app.action)} class="is-current"{/if}>Галерея</a>
            <a href="/gallery/10"{if $app.controller == 'gallery' && isset($app.action) && $app.action == 10} class="is-current"{/if}>Галерея элемент</a>
